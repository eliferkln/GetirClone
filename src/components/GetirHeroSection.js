...
function GetirHeroSection( {showModal, setShowModal,showModal1, setShowModal1,showModal2, setShowModal2 }) {
	...
	return (
		<div
			className="h-auto sm:h-[500px] bg-purple-700 relative before:bg-gradient-to-r before:from-purple-700 before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10 before:absolutebefore:w-full " >
				...
				<div className="w-full sm:container flex mx-auto justify-between items-center">
					<div className="gap-y-10 flex-col hidden sm:flex">
						<img height={180} width={180}
						     src="https://cdn.getir.com/marketing/GetirBuyuk_Logo_1621812275736.png"
						     alt=""/>
						<h3 className="text-4xl font-semibold tracking-tighter	 text-white">
                        Uygun fiyatlarla <br/> kapınızda
						</h3>
					</div>
					<div className="w-full sm:w-[400px] bg-gray-50 sm:rounded-lg px-5 py-3 pb-5 sm:py-6">
						...
						<div className="flex flex-col gap-y-3">
							...
							{showModal &&
							<div className=" w-full h-full absolute items-center justify-center top-0 left-0 flex shadow-2xl  "> <Login setShowModal={setShowModal}/></div>
							 }
							 {showModal1 &&
							<div className=" w-full h-full absolute items-center justify-center top-0 left-0 flex shadow-2xl  "> <Language setShowModal1={setShowModal1}/></div>
							 }
							 	 {showModal2 &&
							<div className=" w-full h-full absolute items-center justify-center top-0 left-0 flex shadow-2xl  "> <Register setShowModal2={setShowModal2}/></div>
							 }
						</div>
					</div>
				</div>
...
export default GetirHeroSection